...
class LValueTests extends AnyFlatSpec {
  ...
  it should "generate the correct ident LValue expression" in {
    val exp = "abcde"
  ...
  it should "generate the correct single array-elem LValue expression" in {
    val exp = "arr[3]"
  ...
  behavior of "array-elem LValue"
  it should "generate the correct multiple array-elem LValue expression" in {
    val exp = "arr[3][4][5]"
  ...
  it should "generate the correct ident pair-elem LValue expression" in {
    val exp = "fst abcde"
  ...
  it should "generate the correct array-elem pair-elem LValue expression" in {
    val exp = "snd arr[1][2]"
  ...
  it should "generate the correct nested pair-elem LValue expression" in {
